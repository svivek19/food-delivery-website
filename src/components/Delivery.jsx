    ...
    <div className="my-10">
      <div className="mx-auto max-w-7xl px-6 lg:px-8 md:my-16">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2
            className="text-base font-semibold leading-7 text-[#52321b]"
            data-aos="fade-up-right"
          >
            Fast & Reliable Delivery
          </h2>
          <p
            className="mt-2 text-3xl font-bold tracking-tight sm:text-4xl text-[#644731]"
            data-aos="fade-up-left"
          >
            Enjoy Delicious Meals Delivered to Your Doorstep
          </p>
          <p
            className="mt-6 text-lg leading-8 text-[#7e6656]"
            data-aos="zoom-in"
          >
